...
export function formatKpi(key: string, value: string | number | null | undefined) {
  if (["npv", "totalOperatingCashFlow", "grossEntryGenerated", "grossEntrySettled", "paymentFees", "netCollections", "preOperationalInvestment"].includes(key)) return formatCurrency(value);
