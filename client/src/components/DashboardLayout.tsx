...
const menuItems = [
  { icon: Settings2, label: "Página 1 · Montagem", path: "/" },
  { icon: LayoutDashboard, label: "Estudo Vivo", path: "/study" },
  { icon: WalletCards, label: "Custos e Pessoas", path: "/costs" },
  { icon: ClipboardCheck, label: "Decisões", path: "/decisions" },
  { icon: GitBranch, label: "Cenários", path: "/scenarios" },
  { icon: ListChecks, label: "Memória e Fontes", path: "/governance" },
];
        ...
        <div className="flex flex-col items-center gap-8 p-8 max-w-md w-full">
          <div className="flex flex-col items-center gap-6">
            ...
            <p className="text-sm text-muted-foreground text-center max-w-sm">
              Entre para montar, ajustar e defender um estudo de viabilidade
              financeira vivo.
            </p>
          </div>
          <Button
